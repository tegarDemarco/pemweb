...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=<aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
        <!--begin::Sidebar Brand-->
          ...
          <nav class="mt-2">
            ...
            <ul
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="/TTWWEB/views/pert3.php" class="nav-link">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Pertemuan 2</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="/TTWWEB/views/pert3latihan.php" class="nav-link">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Pertemuan 3</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="/TTWWEB/content/pert5.php" class="nav-link">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Pertemuan 4</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="/TTWWEB/content/pert5tgs.php" class="nav-link">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Pertemuan 5</p>
                    </a>
                  </li>
